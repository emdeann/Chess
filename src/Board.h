...
public:
	...
	set<int> getMoves(int pos, int range, PieceSide side, char method, bool verifyLegal, ChessPiece& subPiece, int subPieceAt = NONE_SELECTED, int removePieceFrom = NONE_SELECTED) {
